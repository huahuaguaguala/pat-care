...
**技术特色：** Redis 七种数据结构（ZSet / List / BitMap / GEO / HyperLogLog / Set / String）驱动 10 个真实业务场景，Lua 脚本原子秒杀，Redisson 分布式锁防超售。不同于「Redis 仅做缓存」的常规项目，本项目的 Redis 深度是核心竞争力。
...
| AOP | Spring AOP (Controller 耗时日志) | — |
...
│       ├── config/                     # Security / Redis / WebSocket / Swagger / CORS
│       ├── interceptor/                # JWT 拦截器
